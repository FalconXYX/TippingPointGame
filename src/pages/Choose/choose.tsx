    ...
    <section className={styles.container}>
          ...
          backComponent={
            <div className={styles.card}>
              <img
                ...
                className={styles.cardImg}
              />
              <div className={styles.cardContent + " " + styles.grayText}>
                <strong> Activists: </strong>
                Champion environmental balance by striving to maintain high
                global stability and avert ecological collapse.
              </div>
            </div>
          }
        />
          ...
          backComponent={
            <div className={styles.card}>
              ...
              <div className={styles.cardContent}>
                <strong>Anarchists:</strong> Embrace chaos by driving the world
                toward apocalyptic instability to expose systemic failures.
              </div>
            </div>
          }
        />
        <ReactFlipCard
          ...
          backComponent={
            <div className={styles.card}>
              ...
              />
              <div className={styles.cardContent}>
                <strong>Tycoons:</strong> Exploit precarious conditions by
                manipulating instability for profit while keeping collapse at
                bay.
              </div>
            </div>
          }
      ...
      <div className={styles.menu}>
        <div className={styles.menuText}>
          ...
          <p>
            Click each fractions card above to see more information about it,
            and then choose the faction you want to play as
          </p>
        </div>
        <div className={styles.buttonRow}>
          <Button
            ...
            color="success"
            onClick={() =>
              navigate("/game", { state: { faction: "Activist" } })
            }
          >
          ...
          <Button
            ...
            color="error"
            onClick={() =>
              navigate("/game", { state: { faction: "Anarchist" } })
            }
          >
          ...
          <Button
            variant="contained"
            color="warning"
            onClick={() => navigate("/game", { state: { faction: "Tycoon" } })}
          >
